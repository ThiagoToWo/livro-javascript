...
tbPalavras.addEventListener("click", (e) => {
    if (e.target.className == "exclui") {
        ...
        if (confirm(`Confirma a exclusão da palavra ${palavra}?`)) {
            ...
            localStorage.removeItem("forcaPalavras");
            localStorage.removeItem("forcaDicas");
            ...
            localStorage.setItem("forcaPalavras", palavras.join(";"));
            localStorage.setItem("forcaDicas", dicas.join(";"));
        }
    }
});